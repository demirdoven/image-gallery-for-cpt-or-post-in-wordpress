...
(Note that this is a quick method to load styles and scripts. You should always use "admin_enqueue_scripts", "admin_enqueue_styles", "admin_print_scripts-xxx" or "admin_print_styles-xxx" hooks to load styles and scripts for best practice)
```
...
Image URLs which saved on post edit page are stored in WordPress database as post meta data. You can retrieve them by using get_post_meta() function.
